...
void ADC_vInitialize(ADC_eModule_t eModule)
{
    ...
    psBase->ADCON1bits.FORM = 3;                        /* Signed fractional (DOUT = sddd dddd dd00 0000) */
...
void ADC1_CallBack(void)
{
    ...
    if (MAIN_bADC1SyncPrimaryTriggersStatus)
    {
        ...
        #if 1
        ADCStack1[ADC_STACK_CURRENT_L1] = ADC1_ConversionResultGet(ADC_CHANNEL_CURRENT_STACK1_PHASEA); 
        ADCStack1[ADC_STACK_CURRENT_L2] = ADC1_ConversionResultGet(ADC_CHANNEL_CURRENT_STACK1_PHASEB); 
        ADCStack1[ADC_STACK_CURRENT_L3] = ADC1_ConversionResultGet(ADC_CHANNEL_CURRENT_STACK1_PHASEC); 
        ADCStack1[ADC_STACK_DC_VOLTAGE] = ADC1_ConversionResultGet(ADC_CHANNEL_VOLTAGE_DCLINK);
        ADCStack2[ADC_STACK_CURRENT_L1] = ADC1_ConversionResultGet(ADC_CHANNEL_CURRENT_STACK2_PHASEA); 
        ADCStack2[ADC_STACK_CURRENT_L2] = ADC1_ConversionResultGet(ADC_CHANNEL_CURRENT_STACK2_PHASEB); 
        ADCStack2[ADC_STACK_CURRENT_L3] = ADC1_ConversionResultGet(ADC_CHANNEL_CURRENT_STACK2_PHASEC); 
        ADCStack2[ADC_STACK_DC_VOLTAGE] = ADC1_ConversionResultGet(ADC_CHANNEL_VOLTAGE_2);        
        #else
        pu16ADCBUF = (uint16_t*)&ADC1BUF0;
        u8CurrentChannel = 0;
        while(u8CurrentChannel < ADC1_SEQUENCE_COUNT)
...
void ADC2_CallBack(void)
{
    ...
    if (MAIN_bADC2SyncPrimaryTriggersStatus)
    {
        ...
        #if 1
        ADC2Stack1[ADC2_STACK_CURRFBK_L1] = ADC2_ConversionResultGet(ADC_CHANNEL_CURRENT_DRIVER_PHASEA); 
        ADC2Stack1[ADC2_STACK_CURRFBK_L2] = ADC2_ConversionResultGet(ADC_CHANNEL_CURRENT_DRIVER_PHASEB); 
        ADC2Stack1[ADC2_STACK_CURRFBK_L3] = ADC2_ConversionResultGet(ADC_CHANNEL_CURRENT_DRIVER_PHASEC); 
        ADC2Stack1[ADC2_STACK_DCVOLTAGE2] = ADC2_ConversionResultGet(ADC_CHANNEL_VOLTAGE_3);
        ADC2Stack1[ADC2_STACK_TEMPFBK_L1] = ADC2_ConversionResultGet(ADC_CHANNEL_TEMPERATURE_DRIVER_PHASEA); 
        ADC2Stack1[ADC2_STACK_TEMPFBK_L2] = ADC2_ConversionResultGet(ADC_CHANNEL_TEMPERATURE_DRIVER_PHASEB); 
        ADC2Stack1[ADC2_STACK_TEMPFBK_L3] = ADC2_ConversionResultGet(ADC_CHANNEL_TEMPERATURE_DRIVER_PHASEC); 
        ADC2Stack2[ADC2_STACK_DCVOLTAGE2] = ADC2_ConversionResultGet(ADC_CHANNEL_VOLTAGE_4);        
        #else
        pu16ADCBUF = (uint16_t*)&ADC2BUF0;
        u8CurrentChannel = 0;
        while(u8CurrentChannel < ADC2_SEQUENCE_COUNT)
