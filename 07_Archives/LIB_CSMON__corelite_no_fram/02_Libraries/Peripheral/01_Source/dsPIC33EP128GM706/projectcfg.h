...
#define PROJECTCFG_HMLIB_HEXMON_UART_MODULE     0   /* UART_1 */
#define PROJECTCFG_HMLIB_MODBUS_UART_MODULE     0   /* UART_1 */
...
#define USE_SPI_RAM             0          /* TSC -> RAM   MR25H40 (U304) - Old Net Name RP101_F9 */
#define USE_SPI_EEPROM          0          /* TSC -> EEPROM M95M02 (U303) - Old Net Name RP100_F8 */
