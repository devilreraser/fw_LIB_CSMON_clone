...
#define BOARDCFG_USE_UART_2     0
#define BOARDCFG_USE_UART_3     0
#define BOARDCFG_USE_UART_4     0

#define BOARDCFG_USE_SPI_1      1
#define BOARDCFG_USE_SPI_2      1
#define BOARDCFG_USE_SPI_3      0
#define BOARDCFG_USE_SPI_4      0
...
#define BOARDCFG_DEBUG ICD_PGD1
...
#define BOARDCFG_VENDORID_BYTE0     'T'
#define BOARDCFG_VENDORID_BYTE1     'D'
#define BOARDCFG_VENDORID_BYTE2     'B'
#define BOARDCFG_VENDORID_BYTE3     '-'
#define BOARDCFG_PRODUCTID_BYTE0    'P'
#define BOARDCFG_PRODUCTID_BYTE1    '4'
#define BOARDCFG_PRODUCTID_BYTE2    '.'
...
#define BOARDCFG_VENDOR_NAME            "XXXXXXXX"
#define BOARDCFG_PRODUCT_CODE           "TDB"
#define BOARDCFG_MAJOR_MINOR_REVISION   "4.2"
#define BOARDCFG_VENDOR_URL             "www.xxxxxxxx.bg"
#define BOARDCFG_PRODUCT_NAME           "TDB-P4.2"
#define BOARDCFG_MODEL_NAME             "TDB-P4.2-XX"
...
#define BOARDCFG_USE_TSC_SMALL_RELAY_IO_CONFIGURATION   0     /* 0 - means use dummy IO */


/* *****************************************************************************
 * Configuration Definitions Optimize Functionality Disable 
 **************************************************************************** */
#define BOARDCFG_USE_INFO_CALC_MIN_MAX_AVG              0
...
#define BOARDCFG_USE_DAC_TRIP   0
...
#define CS_RAM_SetLow()    /* { CS1_SPI1_SetLow();  } */        /* RAM */
#endif

#if USE_SPI_EEPROM
#define CS_EEPROM_SetHigh()/* { CS1_SPI1_SetHigh(); } */
#define CS_EEPROM_SetLow() /* { CS1_SPI1_SetLow();  } */         /* EEPROM */
#endif

#if USE_SPI_FPGA
#define CS_FPGA_SetHigh()  /* { CS1_SPI1_SetHigh(); } */
#define CS_FPGA_SetLow()   /* { CS1_SPI1_SetLow();  } */         /* FPGA  */
#endif
...
#define DEBUG_SET_ADC_1()       OUT_CTR3_RB5_RB6_SetHigh() 
#define DEBUG_CLR_ADC_1()       OUT_CTR3_RB5_RB6_SetLow()         

#define DEBUG_SET_ADC_2()       OUT_CTR4_RB6_RB7_SetHigh()           
#define DEBUG_CLR_ADC_2()       OUT_CTR4_RB6_RB7_SetLow()        


#define DEBUG_SET_PWM_PSEV()
#define DEBUG_CLR_PWM_PSEV()

#define DEBUG_SET_PWM_SSEV()    OUT_CTR6_RB8_RB9_SetHigh()    
#define DEBUG_CLR_PWM_SSEV()    OUT_CTR6_RB8_RB9_SetLow()    
...
#define DEBUG_SET_MAIN()        OUT_CTR2_RB4_RB5_SetHigh() 
#define DEBUG_CLR_MAIN()        OUT_CTR2_RB4_RB5_SetLow() 


#define DEBUG_SET_MAIN2()       OUT_CTR5_RB7_RB8_SetHigh()      
#define DEBUG_CLR_MAIN2()       OUT_CTR5_RB7_RB8_SetLow()      


#define DEBUG_SET_CTRL()        OUT_CTR1_RB3_RB4_SetHigh()     
#define DEBUG_CLR_CTRL()        OUT_CTR1_RB3_RB4_SetLow()      
