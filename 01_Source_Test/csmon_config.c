...
extern uint16_t u32TimeMainLoopProcessCSMON_Max_Ticks;
extern uint16_t u32TimeCSMON_ISR_Max_Ticks;
extern uint16_t u32TimeMainLoopCycle_Max_Ticks;
extern uint16_t u32TimeCtrlLoopMax_Ticks;
extern uint16_t u32ParamTime_Ticks;
...
volatile const MAIN_sParameterList_t asParameterList[CSMON_CONFIG_PARAMETER_COUNT_MAX] =
{
 /*                ID        Attrib     fucnWr, funcRd, accessWr, accessRd, bStorable,  Offs,     CSMON_DATA_TYPE           MCU Address                          Name               Unit         Max        Min         Def      Norm */
  INIT_PARAMETER(60000,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U16,  &u16PeriodControl_usec,                  "CtrlLoopPeriod",     "usec",    0x0000FFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60001,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U16,  &u16DelayCtrlLoop_100nsec,               "CtrlLoopAddDelay",   "usec",    0x0000FFFF,    0,          0,      0.1F),
  INIT_PARAMETER(60002,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U16,  &u16DelayMainLoop_usec,                  "MainLoopAddDelay",   "usec",    0x0000FFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60003,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U16,  &u16CountSetParameterFail,               "Parameters_Fail",    "unit",    0x0000FFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60004,     CSMON_RO,     0x10,   0x03,        4,        1,         1,     0,                 U32,  &u32TimeMainLoopProcessCSMON_Max_Ticks,  "MainLoopCSMON",      "usec",    0xFFFFFFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60005,     CSMON_RO,     0x10,   0x03,        4,        1,         1,     0,                 U32,  &u32TimeCSMON_ISR_Max_Ticks,             "CtrlLoopCSMON",      "usec",    0xFFFFFFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60006,     CSMON_RO,     0x10,   0x03,        4,        1,         1,     0,                 U32,  &u32TimeMainLoopCycle_Max_Ticks,         "MainLoopMeasMax",    "usec",    0xFFFFFFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60007,     CSMON_RO,     0x10,   0x03,        4,        1,         1,     0,                 U32,  &u32TimeCtrlLoopMax_Ticks,               "CtrlLoopMeasMax",    "usec",    0xFFFFFFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60008,     CSMON_RO,     0x10,   0x03,        4,        1,         1,     0,                 U32,  &u32ParamTime_Ticks,                     "ParamInitMeas",      "usec",    0xFFFFFFFF,    0,          0,      1.0F),
  INIT_PARAMETER(60009,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U8,   &bResetAllTimeMeasures,                  "MeasuresReset",      "unit",    true,          false,      false,  1.0F),

  INIT_PARAMETER(65534,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U16,  &u16DummyDataCnt,                        "ModbusMsgCntr",      "unit",    0x0000FFFF,    0,          0,      0.0F),
  INIT_PARAMETER(    0,     CSMON_WO,     0x10,   0x03,        4,        1,         1,     0,                 U8 ,  &bDummyReqstDevRunning,                  "DeviceRunning",      "boolean", true,          false,      false,  1.0F),    /* Parameter ID 0 - Wr Addr */
  INIT_PARAMETER(    0,     CSMON_RO,     0x10,   0x03,        4,        1,         1,     0,                 U8 ,  &bDummyStatsDevRunning,                  "DeviceRunning",      "boolean", true,          false,      false,  1.0F),    /* Parameter ID 0 - Rd Addr */
  INIT_PARAMETER(    1,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S16,  &s16ScaleDataTst,                        "ReadWriteScale",     "*3.1415", 10000,         -10000,     0,      3.1415F),
  INIT_PARAMETER(    2,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S16,  &s16DummyIncrementLoop,                  "IncLoopTest",        "A(0.5V)", 10000,         -10000,     0,      1.0F),
  INIT_PARAMETER(    3,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S16,  &s16DummyCurrentPhaseA,                  "CurrentPhA",         "A",       10000,         -10000,     0,      1.0F),
  INIT_PARAMETER(    4,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S16,  &s16DummyCurrentPhaseB,                  "CurrentPhB",         "A",       10000,         -10000,     0,      1.0F),
  INIT_PARAMETER(    5,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S16,  &s16DummyCurrentPhaseC,                  "CurrentPhC",         "A",       10000,         -10000,     0,      1.0F),
  INIT_PARAMETER(    6,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U32,  &u32GetBaudError_PPM,                    "BaudError",          "%",       10000,         0,          0,      0.0001F),
  INIT_PARAMETER(    7,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 U16,  &u16WatchdogPrescalerTime,               "WatchdogTime",       "msec",    64,            1,          0,      ((1000.0*512*256)/10000000.0)),  /* 1msec; 512WatchdogDiv; 256WatchdogCnt; 10MHz INTOSC */
  ...
  INIT_PARAMETER(   28,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S32,  &s32DummyVoltageDCLink,                  "VoltageBus32",       "V",       1000000000,    -1000000000,0,      0.000001F),
  INIT_PARAMETER(   29,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S32,  &s32DummyCurrentPhaseA,                  "CurrentPhA32",       "A",       1000000000,    -1000000000,0,      0.000001F),
  INIT_PARAMETER(   30,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S32,  &s32DummyCurrentPhaseB,                  "CurrentPhB32",       "A",       1000000000,    -1000000000,0,      0.000001F),
  INIT_PARAMETER(   31,     CSMON_RW,     0x10,   0x03,        4,        1,         1,     0,                 S32,  &s32DummyCurrentPhaseC,                  "CurrentPhC32",       "A",       1000000000,    -1000000000,0,      0.000001F),
