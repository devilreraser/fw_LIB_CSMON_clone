...
SECTIONS
{
   ...
   .cinit              : > FLASHABCDEFG      PAGE = 0, ALIGN(4)
   .pinit              : > FLASHABCDEFG,     PAGE = 0, ALIGN(4)
   .text               : > FLASHABCDEFG     PAGE = 0, ALIGN(4)
   codestart           : > BEGIN       PAGE = 0, ALIGN(4)

#ifdef __TI_COMPILER_VERSION__
   #if __TI_COMPILER_VERSION__ >= 15009000
    .TI.ramfunc : {} LOAD = FLASHABCDEFG,
                         RUN = RAMLS0,
