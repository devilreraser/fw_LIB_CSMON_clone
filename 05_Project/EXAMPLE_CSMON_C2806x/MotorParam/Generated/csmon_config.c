...
extern char charUserStringConfiguration[16];
extern uint_least8_t au8UserStringConfiguration[16];
extern uint16_t au16UserStringConfiguration[16];
extern uint16_t au16UserStringConfiguration2[32];
...
//INIT_PARAMETER(60000,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 U16,  &u16PeriodControl_usec,                 "CtrlLoopPeriod",   "usec",         65535,           0,     0,    1.0F),
//INIT_PARAMETER(60001,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 U16,  &u16DelayCtrlLoop_100nsec,              "CtrlLoopAddDelay", "usec",         65535,           0,     0,    0.100000001490116F),
//INIT_PARAMETER(60002,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 U16,  &u16DelayMainLoop_usec,                 "MainLoopAddDelay", "usec",         65535,           0,     0,    1.0F),
//INIT_PARAMETER(60003,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 U16,  &u16CountSetParameterFail,              "Parameters_Fail",  "unit",         65535,           0,     0,    1.0F),
//INIT_PARAMETER(60004,      CSMON_RO,     0x00,   0x03,        4,        1,         1,    0,    1,                 U32,  &u32TimeMainLoopProcessCSMON_Max_Ticks, "MainLoopCSMON",    "usec",    4294967295,           0,     0,    1.0F),
//INIT_PARAMETER(60005,      CSMON_RO,     0x00,   0x03,        4,        1,         1,    0,    1,                 U32,  &u32TimeCSMON_ISR_Max_Ticks,            "CtrlLoopCSMON",    "usec",    4294967295,           0,     0,    1.0F),
//INIT_PARAMETER(60006,      CSMON_RO,     0x00,   0x03,        4,        1,         1,    0,    1,                 U32,  &u32TimeMainLoopCycle_Max_Ticks,        "MainLoopMeasMax",  "usec",    4294967295,           0,     0,    1.0F),
//INIT_PARAMETER(60007,      CSMON_RO,     0x00,   0x03,        4,        1,         1,    0,    1,                 U32,  &u32TimeCtrlLoopMax_Ticks,              "CtrlLoopMeasMax",  "usec",    4294967295,           0,     0,    1.0F),
//INIT_PARAMETER(60008,      CSMON_RO,     0x00,   0x03,        4,        1,         1,    0,    1,                 U32,  &u32ParamTime_Ticks,                    "ParamInitMeas",    "usec",    4294967295,           0,     0,    1.0F),
//INIT_PARAMETER(60009,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                  U8,  &bResetAllTimeMeasures,                 "MeasuresReset",    "boolean",          1,           0,     0,    1.0F),
//INIT_PARAMETER(65534,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 U16,  &u16DummyDataCnt,                       "ModbusMsgCntr",    "unit",         65535,           0,     0,    0.0F),
//INIT_PARAMETER(    0,      CSMON_RO,     0x10,   0x03,        4,        1,         1,    0,    1,                  U8,  &bDummyStatsDevRunning,                 "DeviceRunning",    "boolean",          1,           0,     0,    1.0F),
//INIT_PARAMETER(    0,      CSMON_WO,     0x10,   0x03,        4,        1,         1,    0,    1,                  U8,  &bDummyReqstDevRunning,                 "DeviceRunning",    "boolean",          1,           0,     0,    1.0F),
//INIT_PARAMETER(    1,      CSMON_RW,     0x10,   0x03,        4,        0,         1,    0,    1,                 S16,  &s16ScaleDataTst,                       "ReadWriteScale",   "*3.1415",      10000,      -10000,     0,    3.1414999961853F),
//INIT_PARAMETER(    2,      CSMON_RW,     0x10,   0x03,        4,        0,         1,    0,    1,                 S16,  &s16DummyIncrementLoop,                 "IncLoopTest",      "A(0.5V)",      10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(    3,      CSMON_RW,     0x10,   0x03,        4,        0,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseA,                 "CurrentPhA_0",     "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(    4,      CSMON_RW,     0x10,   0x03,        4,        0,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseB,                 "CurrentPhB_0",     "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(    5,      CSMON_RW,     0x10,   0x03,        4,        0,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseC,                 "CurrentPhC_0",     "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(    6,      CSMON_RO,     0x00,   0x03,        4,        0,         1,    0,    1,                 U32,  &u32GetBaudError_PPM,                   "BaudError",        "%",            10000,           0,     0,    9.99999974737875E-05F),
//INIT_PARAMETER(    7,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 U16,  &u16WatchdogPrescalerTime,              "WatchdogTime",     "msec",            64,           1,     0,    13.1071996688843F),
//INIT_PARAMETER(    8,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyVoltageDCLink,                 "VoltageBus",       "V",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(    9,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseA,                 "CurrentPhA",       "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(   10,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseB,                 "CurrentPhB",       "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(   11,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseC,                 "CurrentPhC",       "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(   28,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S32,  &s32DummyVoltageDCLink,                 "VoltageBus32",     "V",       1000000000, -1000000000,     0,    9.99999997475243E-07F),
//INIT_PARAMETER(   29,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S32,  &s32DummyCurrentPhaseA,                 "CurrentPhA32",     "A",       1000000000, -1000000000,     0,    9.99999997475243E-07F),
//INIT_PARAMETER(   30,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S32,  &s32DummyCurrentPhaseB,                 "CurrentPhB32",     "A",       1000000000, -1000000000,     0,    9.99999997475243E-07F),
//INIT_PARAMETER(   31,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S32,  &s32DummyCurrentPhaseC,                 "CurrentPhC32",     "A",       1000000000, -1000000000,     0,    9.99999997475243E-07F),
//INIT_PARAMETER(  108,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyVoltageDCLinkStartup,          "VoltageBusStart",  "V",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  109,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseAStartup,          "CurrentPhAStart",  "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  110,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseBStartup,          "CurrentPhBStart",  "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  111,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseCStartup,          "CurrentPhCStart",  "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  208,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyVoltageDCLinkStop,             "VoltageBusStop",   "V",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  209,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseAStop,             "CurrentPhAStop",   "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  210,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseBStop,             "CurrentPhBStop",   "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  211,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseCStop,             "CurrentPhCStop",   "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  308,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyVoltageDCLinkIdle,             "VoltageBusIdle",   "V",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  309,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseAIdle,             "CurrentPhAIdle",   "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  310,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseBIdle,             "CurrentPhBIdle",   "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  311,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyCurrentPhaseCIdle,             "CurrentPhCIdle",   "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  408,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyIncrementLoopA,                "IncLoopTestA",     "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  409,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyIncrementLoopB,                "IncLoopTestB",     "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  410,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyIncrementLoopC,                "IncLoopTestC",     "A",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  411,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyIncrementLoopV,                "IncLoopTestV",     "V",            10000,      -10000,     0,    1.0F),
//INIT_PARAMETER(  412,      CSMON_RW,     0x10,   0x03,        4,        1,         1,    0,    1,                 S16,  &s16DummyIncrementLoopCDiff,            "IncLoopTestCDiff", "A",            10000,      -10000,     0,    1.0F),
INIT_PARAMETER(   32,      CSMON_RO,     0x00,   0x14,      255,        0,         1,    0,   16,                 AU8,  &au8UserStringConfiguration,            "ConfigNameAU8",     "",              255,           0,     0,    1.0F),
INIT_PARAMETER(   33,      CSMON_RO,     0x00,   0x14,      255,        0,         1,    0,   16,                CHAR,  &charUserStringConfiguration,           "ConfigNameCHAR",    "",              255,           0,     0,    1.0F),
INIT_PARAMETER(   34,      CSMON_RO,     0x00,   0x14,      255,        0,         1,    0,   16,                AU16,  &au16UserStringConfiguration,           "ConfigNameAU16",    "",            65535,           0,     0,    1.0F),
INIT_PARAMETER(   35,      CSMON_RO,     0x00,   0x14,      255,        0,         1,    0,   32,                AU16,  &au16UserStringConfiguration2,          "ConfigNameAU16_2",  "",            65535,           0,     0,    1.0F),
