...
#define INIT_PARAMFULL(u16ID, paramAccess, funcWr, funcRd, accessWr, accessRd, bStorable, u8Offs, u8Elements, DataTypeAttribute, u32Address, strName, strUnit, u32Maximum, u32Minimum, u32Default, floatScale, VisualAttribute, bitField, arrayType, bNR, bNW, pFunc) \
 { \
    ...
    .uParameterSize.sSize.u8SizeElement = (u8Elements > 1) * 0 + (u8Elements == 1) * BYTES_COUNT(DataTypeAttribute), /* String Encoded Normal (u8Elements > 1) u8SizeElement = 0 */\
...
INIT_PARAMETER(   32,      CSMON_RO,     0x00,   0x14,      255,        0,         1,    0,   16,                 AU8,  &UserStringConfiguration,               "ConfigName",       "",               255,           0,     0,    1.0F),
