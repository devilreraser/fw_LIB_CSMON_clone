...
typedef enum
{
    /* See also HMRECPRM_VARIANT_ instead of CSMON_DATA_ */
    CSMON_DATA_TYPE_NUMBER_ARRAY_FLAG = 0x1000,     /* Number Array Flag */
    ...
    CSMON_DATA_TYPE_AU32 = 0x0402,         /* Not used or tested in CSMON PC Application */
    CSMON_DATA_TYPE_AU64 = 0x0403,         /* Not used or tested in CSMON PC Application */

    CSMON_DATA_TYPE_NAU8  = 0x1000,         /* Number Array */
    CSMON_DATA_TYPE_NAU16 = 0x1001,         /* Number Array */
    CSMON_DATA_TYPE_NAU32 = 0x1002,         /* Number Array */
    CSMON_DATA_TYPE_NAU64 = 0x1003,         /* Number Array */


    CSMON_DATA_TYPE_NAS8  = 0x1080,         /* Number Array */
    CSMON_DATA_TYPE_NAS16 = 0x1081,         /* Number Array */
    CSMON_DATA_TYPE_NAS32 = 0x1082,         /* Number Array */
    CSMON_DATA_TYPE_NAS64 = 0x1083,         /* Number Array */

    CSMON_DATA_TYPE_NAF16 = 0x10C1,         /* Number Array */
    CSMON_DATA_TYPE_NAF32 = 0x10C2,         /* Number Array */
    CSMON_DATA_TYPE_NAF64 = 0x10C3,         /* Number Array */
...
typedef struct sCDeviceID_t_
{
    const char* pVendorName;
    const char* pProductCode;
    const char* pMajorMinorRevision;
    const char* pVendorUrl;
    const char* pProductName;
    const char* pModelName;
    const char* pUserApplicationName;
    const char* pUserReserve0;
    const char* pUserReserve1;
    const char* pUserReserve2;
} sCDeviceID_t;
...
void CSMON_vDeviceIDVendorName_set(const char* pDeviceIDVendorName);
void CSMON_vDeviceIDProductCode_set(const char* pDeviceIDProductCode);
void CSMON_vDeviceIDMajorMinorRevision_set(const char* pDeviceIDMajorMinorRevision);
void CSMON_vDeviceIDVendorUrl_set(const char* pDeviceIDVendorUrl);
void CSMON_vDeviceIDProductName_set(const char* pDeviceIDProductName);
void CSMON_vDeviceIDModelName_set(const char* pDeviceIDModelName);
void CSMON_vDeviceIDUserApplicationName_set(const char* pDeviceIDUserApplicationName);
void CSMON_vDeviceIDUserReserve0_set(const char* pDeviceIDUserReserve0);
void CSMON_vDeviceIDUserReserve1_set(const char* pDeviceIDUserReserve1);
void CSMON_vDeviceIDUserReserve2_set(const char* pDeviceIDUserReserve2);


inline static void CSMON_vDeviceID_set(const sCDeviceID_t* const pDeviceID)
{
    CSMON_vDeviceIDVendorName_set(pDeviceID->pVendorName);
    CSMON_vDeviceIDProductCode_set(pDeviceID->pProductCode);
    CSMON_vDeviceIDMajorMinorRevision_set(pDeviceID->pMajorMinorRevision);
    CSMON_vDeviceIDVendorUrl_set(pDeviceID->pVendorUrl);
    CSMON_vDeviceIDProductName_set(pDeviceID->pProductName);
    CSMON_vDeviceIDModelName_set(pDeviceID->pModelName);
    CSMON_vDeviceIDUserApplicationName_set(pDeviceID->pUserApplicationName);
    CSMON_vDeviceIDUserReserve0_set(pDeviceID->pUserReserve0);
    CSMON_vDeviceIDUserReserve1_set(pDeviceID->pUserReserve1);
    CSMON_vDeviceIDUserReserve2_set(pDeviceID->pUserReserve2);
}
